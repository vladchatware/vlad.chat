...
export const Reasoning = memo(
  ({
    ...
    return (
      ...
      >
        <Collapsible
          className={cn("not-prose mb-4 w-full rounded-md border bg-muted/50", className)}
...
export const ReasoningTrigger = memo(
  ({ className, children, ...props }: ReasoningTriggerProps) => {
    ...
    return (
      <CollapsibleTrigger
        className={cn(
          "flex w-full items-center gap-2 p-3 text-muted-foreground text-sm transition-colors hover:text-foreground",
          className
        )}
        {...props}
      >
